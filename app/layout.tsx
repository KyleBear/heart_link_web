...
export const metadata: Metadata = {
  title: "하트바이브 — 나의 사람을 만나다. 스와이프, 매칭, 연결.",
  description:
    "하트바이브는 진짜 인연이 만들어지는 데이팅 앱입니다. 스와이프로 발견하고, 나를 알아주는 사람과 매칭되고, 실시간으로 채팅·통화하세요. 의미 있는 관계를 찾는 1만 명 이상과 함께하세요.",
  keywords: [
    "데이팅 앱",
    "매칭",
    "채팅",
